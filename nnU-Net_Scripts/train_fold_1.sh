#!/bin/bash
# ============================================================
# nnU-Net Training — Fold 1 of 5 — HPC SLURM Batch Script
# Author: Zhihan Xu
# Date: May 2026
# ============================================================
# Description:
...
#   Submit via: sbatch train_fold_1.sh in a terminal
#
# Input:  Preprocessed data under nnUNet_preprocessed
# Output: Trained fold 1 model saved to nnUNet_results
# ============================================================

# ------ SLURM job configuration ----------------------------
#SBATCH --job-name=nnunet_f1
...
#SBATCH --output=/path/to/logs/train_f1_%j.out  # %j is replaced by job ID automatically
...
# 2d   : 2D configuration
# 1    : fold index (0–4 across the five scripts)
# --npz : saves softmax probability maps needed for ensembling
nnUNetv2_train 501 2d 1 --npz
