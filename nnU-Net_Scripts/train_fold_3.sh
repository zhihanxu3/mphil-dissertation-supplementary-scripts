...
# ============================================================
# Description:
#   Trains nnU-Net v2 on fold 3 of a 5-fold cross-validation (folds 0-4)
...
#   Submit via: sbatch train_fold_3.sh in a terminal
#
# Input:  Preprocessed data under nnUNet_preprocessed
# Output: Trained fold 3 model saved to nnUNet_results
# ============================================================

# ------ SLURM job configuration ----------------------------
#SBATCH --job-name=nnunet_f3
...
#SBATCH --output=/path/to/logs/train_f3_%j.out  # %j is replaced by job ID automatically
...
# 2d   : 2D configuration
# 3    : fold index (0–4 across the five scripts)
# --npz : saves softmax probability maps needed for ensembling
nnUNetv2_train 501 2d 3 --npz
