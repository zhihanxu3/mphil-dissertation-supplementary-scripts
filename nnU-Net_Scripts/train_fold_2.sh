#!/bin/bash
# ============================================================
# nnU-Net Training — Fold 2 — 5-Fold Cross-Validation — HPC SLURM Batch Script
# Author: Zhihan Xu
# Date: May 2026
# ============================================================
# Description:
#   Trains nnU-Net v2 on fold 2 of a 5-fold cross-validation (folds 0-4)
...
#   Submit via: sbatch train_fold_2.sh in a terminal
#
# Input:  Preprocessed data under nnUNet_preprocessed
# Output: Trained fold 2 model saved to nnUNet_results
# ============================================================
...
#SBATCH --output=/path/to/logs/train_f2_%j.out  # %j is replaced by job ID automatically
...
# 2d   : 2D configuration
# 2    : fold index (0–4 across the five scripts)
