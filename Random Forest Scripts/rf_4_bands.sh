#!/bin/bash
# ============================================================
# Random Forest Classification (4 bands) — HPC SLURM Batch Script
# Author: Zhihan Xu
# Date: May 2026
# ============================================================
# Description:
#   Submits random_forest_classification_4_bands.py as a CPU batch
...
#   PlanetScope imagery.
#   Submit via: sbatch rf_4_bands.sh
#
# Important — before submitting:
#   Open random_forest_classification_4_bands.py and confirm that
...
#SBATCH --output=/path/to/your/logs/rf_4_bands_%j.out  # %j is replaced by job ID automatically
...
python /path/to/your/random_forest_classification_4_bands.py
